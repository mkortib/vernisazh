...
get_current_screen()->add_help_tab( array(
	...
	'content' =>
		...
		'<p>' . __( 'You can sort the table by clicking on any of the table headings and switch between list and excerpt views by using the ics above the users list.' ) . '</p>' .
