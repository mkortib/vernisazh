	...
	<fieldset id="color-picker" class="scheme-list">
		...
		foreach ( $_wp_admin_css_colors as $color => $color_info ) :
			...
			<div class="color-option <?php echo ( $color == $current_color ) ? 'selected' : ''; ?>">
				...
				<input type="hidden" class="icon_colors" value="<?php echo esc_attr( wp_json_encode( array( 'ics' => $color_info->icon_colors ) ) ); ?>" />
...
function wp_color_scheme_settings() {
	...
	echo '<script type="text/javascript">var _wpColorScheme = ' . wp_json_encode( array( 'ics' => $icon_colors ) ) . ";</script>\n";
}
