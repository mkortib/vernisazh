 ...
 *
 * @since 2.7.0
 * @since 3.8.0 Screen ics are no longer used in WordPress. This function no longer produces output.
...
function get_screen_icon() {
	return '<!-- Screen ics are no longer used as of WordPress 3.8. -->';
}
