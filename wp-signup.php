...
function validate_another_blog_signup() {
	global $wpdb, $blogname, $blog_title, $errors, $domain, $s;
	$current_user = wp_get_current_user();
	if ( ! is_user_logged_in() ) {
		die();
	}
	...
	$blog_id = wpmu_create_blog( $domain, $s, $blog_title, $current_user->ID, $meta, $wpdb->siteid );

	if ( is_wp_error( $blog_id ) ) {
		return false;
	}

	confirm_another_blog_signup( $domain, $s, $blog_title, $current_user->user_login, $current_user->user_email, $meta, $blog_id );
	return true;
}
