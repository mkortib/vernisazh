...
<div class="popup">
    <div class="close"></div>
    <div class="caption">
        <h2><?php echo __('[:ru]Обратный звонок[:ua]Зворотній зв\'язок[:]');?></h2>
        <p><?php echo __('[:ru]Оставьте номер и наш менеджер
             позвонит в течение 15 минут.[:ua]Залиште Ваш номер і наш менеджер
            зателефонує протягом 15 хвилин.[:]');?></p>
    </div>
    <form>
...
<?php if ( is_category(5 ) ): ?>
    ...
    <?php if (qtranxf_getLanguage() == 'ua'): ?>
        ...
        function drawCrosshairs() {
            ...
            data.addColumn('number', 'Вартість кв. м, грн');

            data.addRows([
                [0, 9000], [10, 10000], [20, 10500], [30, 10750], [40, 11000], [50, 11500],
                [60, 11274], [70, 12000], [80, 13453], [90, 16850], [100, 17000]
            ]);

            var options = {
                title: 'Графік росту цін в залежності від готовності',
                hAxis: {
                    title: '% готовності'
                },
                vAxis: {
                    title: 'Вартість кв. м., грн'
                },
    ...
    <?php elseif (qtranxf_getLanguage() == 'ru'): ?>
        <script type="text/javascript">
            ...
            function drawCrosshairs() {
                var data = new google.visualization.DataTable();
                data.addColumn('number', 'X');
                data.addColumn('number', 'Стоимость кв. м, грн');
                ...
                var options = {
                    title: 'График роста цен в зависимости от готовности',
                    hAxis: {
                        title: '% готовности'
                    },
                    vAxis: {
                        title: 'Стоимость кв. м, грн'
                    },
                    colors: ['#a52714', '#097138'],
                    crosshair: {
                        color: '#000',
